...
public class WeekkFragment extends BaseFragment {
    private String symbol;
    private WebView webView;

    public WeekkFragment() {
    }

    public static WeekkFragment newInstance(String symbol) {
        WeekkFragment fragment = new WeekkFragment();
