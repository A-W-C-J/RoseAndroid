...
public class SuperCircleView extends View {
  ...
  private static final String TAG = "SuperCircleView";
  ...
  public SuperCircleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    mMinRadio = a.getInteger(R.styleable.SuperCircleView_min_circle_radio, Utils.getWidth() / 4);
    Log.e(TAG, "SuperCircleView: " + mMinRadio);
    ...
    mMinCircleColor = a.getColor(R.styleable.SuperCircleView_circle_color, ContextCompat.getColor(context,R.color.bg_color_1));
    mMaxCircleColor = a.getColor(R.styleable.SuperCircleView_max_circle_color, ContextCompat.getColor(context,R.color.bg_color_1));
    mRingNormalColor = a.getColor(R.styleable.SuperCircleView_ring_normal_color, ContextCompat.getColor(context,R.color.red));
  ...
  protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
    ...
    mViewCenterX = mViewWidth;
    mViewCenterY = mViewHeight;
    ...
    mRingAngleWidth = (float) (360 - mSelect * mSelectAngle) / mSelect;
  }
