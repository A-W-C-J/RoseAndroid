...
public class EndlessRecyclerOnScrollListener extends RecyclerView.OnScrollListener implements OnListLoadNextPageListener {
  ...
  public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
    ...
    Log.e(TAG, "onScrollStateChanged: " + "lastVisibleItemPosition" + lastVisibleItemPosition + "totalItemCount" + totalItemCount);
    if ((visibleItemCount > 0 && totalItemCount - 1 > visibleItemCount && currentScrollState == RecyclerView.SCROLL_STATE_IDLE && (lastVisibleItemPosition) >= totalItemCount - 1)) {
